...
if len(qdrant_container_ports[0]) < 2: 
...
doc_index = load_or_create_doc_index(doc_db_client)
...
print(any(collection.name == CHAT_DB_COLLECTION_NAME for collection in chat_db_collections))
